...
public class BLMediaController extends ConstraintLayout implements View.OnClickListener, IMediaController {
    ...
    protected void initView() {
        ...
        mTvSelect.setText("选集");
        mTvSelect.setTextColor(Color.WHITE);
        setPlayOrPause(playOrPause);
        setFullOrCancel(fullOrCancel);
        mIvPlayNext.setImageResource(ICON_NEXT);
        mSeekBar.setThumb(getResources().getDrawable(SEEKBAR_THUMB));
        mSeekBar.setProgressDrawable(getResources().getDrawable(SEEKBAR_BACKGROUND));
    }
    ...
    public void setPlayOrPause(boolean b) {
        playOrPause = b;
        if (playOrPause) {
            mIvPlayOrPause.setImageResource(ICON_PLAY);
        } else {
            mIvPlayOrPause.setImageResource(ICON_PAUSE);
        }
    }
    ...
    public void setFullOrCancel(boolean b) {
        fullOrCancel = b;
        if (fullOrCancel) {
            mIvFullScreen.setImageResource(ICON_FULL_SCREEN);
        } else {
            mIvFullScreen.setImageResource(ICON_CANCEL_FULL_SCREEN);
        }
    }
    ...
    protected void showDefaultType() {
        removeAllViews();
        //播放按钮
        ConstraintLayout.LayoutParams ivPlayOrPauseParams = new ConstraintLayout.LayoutParams(ScreenUtil.dp2px(24), ScreenUtil.dp2px(24));
        ivPlayOrPauseParams.topToTop = 0;
        ivPlayOrPauseParams.bottomToBottom = 0;
        ivPlayOrPauseParams.startToStart = 0;
        ivPlayOrPauseParams.setMarginStart(ScreenUtil.dp2px(16));
        ivPlayOrPauseParams.bottomMargin = ScreenUtil.dp2px(10);
        ...
        tvNowParams.setMarginStart(ScreenUtil.dp2px(16));
        mTvNow.setLayoutParams(tvNowParams);
        addView(mTvNow);
        //全屏图标
        ConstraintLayout.LayoutParams ivFullParams = new ConstraintLayout.LayoutParams(ScreenUtil.dp2px(24), ScreenUtil.dp2px(24));
        ivFullParams.topToTop = mIvPlayOrPause.getId();
        ivFullParams.bottomToBottom = mIvPlayOrPause.getId();
        ivFullParams.endToEnd = 0;
        ivFullParams.setMarginEnd(ScreenUtil.dp2px(16));
        ...
        tvAllParams.setMarginEnd(ScreenUtil.dp2px(16));
        mTvAll.setLayoutParams(tvAllParams);
        addView(mTvAll);
        //进度条
        ConstraintLayout.LayoutParams seekBarParams = new ConstraintLayout.LayoutParams(LayoutParams.MATCH_CONSTRAINT, ScreenUtil.dp2px(24));
    ...
    protected void showType_land() {
        ...
        ivPlayOrPauseParams.startToStart = 0;
        ivPlayOrPauseParams.setMarginStart(ScreenUtil.dp2px(16));
        ivPlayOrPauseParams.bottomMargin = ScreenUtil.dp2px(18);
        mIvPlayOrPause.setLayoutParams(ivPlayOrPauseParams);
        addView(mIvPlayOrPause);
        //下一集
        ConstraintLayout.LayoutParams ivNextParams = new ConstraintLayout.LayoutParams(ScreenUtil.dp2px(24), ScreenUtil.dp2px(24));
        ...
        ivNextParams.setMarginStart(ScreenUtil.dp2px(16));
        ...
        tvSelectParams.goneEndMargin = ScreenUtil.dp2px(16);
        tvSelectParams.setMarginEnd(ScreenUtil.dp2px(16));
        ...
        tvNowParams.bottomMargin = ScreenUtil.dp2px(24);
        tvNowParams.setMarginStart(ScreenUtil.dp2px(16));
        mTvNow.setLayoutParams(tvNowParams);
        addView(mTvNow);
        //播放总时长
